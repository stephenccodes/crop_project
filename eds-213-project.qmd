...
# `{r} # df1 <- data.frame(colnames(fao_clean)) # df2 <- data.frame(colnames(crop_calendar_clean)) #`

# 

# `{r} # common_values <- intersect(df1$colnames.fao_clean., df2$colnames.crop_calendar_clean.) #`
